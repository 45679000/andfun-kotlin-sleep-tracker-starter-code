...
//Create annotated interface SleepDatabase Dao
@Dao
...
//Add annotated get() method that gets the the SleepNight by key
    @Query("SELECT * from daily_sleep_quality_table WHERE nightId = :key")
    fun get(key: Long): sleepNight


    //Add annotated clear() method and query
    // deletes everything fom the table
    ...
    //Add annotated getTonight() method and query - latest night
